...
public class GetOrLaunchWorldRaidCommand {
    ...
    private final WorldRaidBattleGenerator worldRaidBattleGenerator;
    ...
    public GetOrLaunchWorldRaidCommand(
        ...
        WorldRaidBattleGenerator worldRaidBattleGenerator,
        ResearchGenerator researchGenerator,
        WorldRaidConfig config
    ) {
        this.storage = storage;
        this.worldRaidBattleGenerator = worldRaidBattleGenerator;
    ...
    public ActiveWorldRaid execute() {
        ...
        final var launchedInfo = worldRaidBattleGenerator.launchedFromTemplate(template.info());
        storage.saveActive(
            template.eventId(),
            launchedInfo,
