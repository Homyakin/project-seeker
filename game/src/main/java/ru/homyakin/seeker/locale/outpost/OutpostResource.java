...
public record OutpostResource(
    ...
    String fieldArsenal,
    String fieldArsenalLevel0,
    String fieldArsenalLevel1,
    String fieldArsenalLevel2,
    String fieldArsenalLevel3,
    String fieldArsenalLevel4,
    String fieldArsenalLevel5,
    ...
    String donateItemSuccessLoadoutWarning,
    String donateItemBuildingCompletePrivate,
    String confirmDonateLoadout,
    String confirmDonateButton,
    String cancelDonateButton,
    String cancelDonate,
