...
public enum CommandType {
    ...
    OPEN_LOADOUT("openLoadout", CheckType.EQUALS),
    CREATE_LOADOUT("createLoadout", CheckType.EQUALS),
    SAVE_LOADOUT("saveLoadout", CheckType.EQUALS),
    APPLY_LOADOUT("applyLoadout", CheckType.EQUALS),
    RENAME_LOADOUT("renameLoadout", CheckType.EQUALS),
    DELETE_LOADOUT("deleteLoadout", CheckType.EQUALS),
    CONFIRM_DELETE_LOADOUT("confirmDeleteLoadout", CheckType.EQUALS),
    CANCEL_DELETE_LOADOUT("cancelDeleteLoadout", CheckType.EQUALS),
    LOADOUTS_LIST("loadoutsList", CheckType.EQUALS),
    CANCEL_CREATE_LOADOUT("cancelCreateLoadout", CheckType.EQUALS),
    DEFAULT_LOADOUTS("defaultLoadouts", CheckType.EQUALS),
    OPEN_DEFAULT_LOADOUT_EVENT("openDefaultLoadoutEvent", CheckType.EQUALS),
    TOGGLE_DEFAULT_LOADOUT("toggleDefaultLoadout", CheckType.EQUALS),
    ...
    CONFIRM_SELL_ITEM("confirmSell", CheckType.EQUALS),
    CANCEL_SELL_ITEM("cancelSell", CheckType.EQUALS),
    ...
    TOP_GROUP_ANOMALY_RATING("/topg_anomaly", CheckType.EQUALS),
    ...
    GROUP_KICK("/gkick", CheckType.STARTS_WITH),
    ...
    CONFIRM_GROUP_KICK("confirmGroupKick", CheckType.EQUALS),
    CANCEL_GROUP_KICK("cancelGroupKick", CheckType.EQUALS),
    ...
    CONFIRM_STORM_ENHANCE("/senhance", CheckType.STARTS_WITH),
    ...
    OUTPOST_BUILD_CONTRIBUTE("outpostBldGive", CheckType.EQUALS),
