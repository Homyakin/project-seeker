...
@Component
public class TopDonateExecutor extends CommandExecutor<TopDonate> {
    private final TopService topService;
    private final GroupUserService groupUserService;
    private final TelegramSender telegramSender;

    public TopDonateExecutor(
    ...
    @Override
    public void execute(TopDonate command) {
        ...
        final var top = topService.getTopDonateGroup(group.domainGroupId());
