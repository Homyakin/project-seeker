...
@Component
public class TopOutpostSeasonMaterialsExecutor extends CommandExecutor<TopOutpostSeasonMaterials> {
    private final TopService topService;
    private final GroupUserService groupUserService;
    private final TelegramSender telegramSender;

    public TopOutpostSeasonMaterialsExecutor(
    ...
    @Override
    public void execute(TopOutpostSeasonMaterials command) {
        ...
        final var top = topService.getTopOutpostSeasonGroup(group.domainGroupId());
