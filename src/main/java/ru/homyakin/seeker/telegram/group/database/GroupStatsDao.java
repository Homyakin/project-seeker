...
public class GroupStatsDao {
    ...
    public Optional<GroupStats> getById(long groupId) {
        String sql = "SELECT * FROM grouptg_stats WHERE grouptg_id = :grouptg_id";
        final var param = Collections.singletonMap("grouptg_id", groupId);
    ...
    public void increaseRaidsComplete(long groupId, int amount) {
        String sql = "UPDATE grouptg_stats SET raids_complete = raids_complete + :amount WHERE grouptg_id = :grouptg_id";
        final var params = new MapSqlParameterSource()
            .addValue("amount", amount)
            .addValue("grouptg_id", groupId);
        jdbcTemplate.update(sql, params);
    }

    public void increaseDuelsComplete(long groupId, int amount) {
        String sql = "UPDATE grouptg_stats SET duels_complete = duels_complete + :amount WHERE grouptg_id = :grouptg_id";
        final var params = new MapSqlParameterSource()
            .addValue("amount", amount)
            .addValue("grouptg_id", groupId);
        jdbcTemplate.update(sql, params);
    ...
    public void increaseTavernMoneySpent(long groupId, long amount) {
        String sql = "UPDATE grouptg_stats SET tavern_money_spent = tavern_money_spent + :amount WHERE grouptg_id = :grouptg_id";
        final var params = new MapSqlParameterSource()
            .addValue("amount", amount)
            .addValue("grouptg_id", groupId);
        jdbcTemplate.update(sql, params);
