...
public class CharacteristicLocalization {
    ...
    public static String successReset(Language language) {
        return CommonUtils.ifNullThan(map.get(language).successReset(), map.get(Language.DEFAULT).successReset());
    }

    public static String canceledReset(Language language) {
        return CommonUtils.ifNullThan(map.get(language).canceledReset(), map.get(Language.DEFAULT).canceledReset());
    }
    ...
    public static String increasedCharacteristic(Language language, CharacteristicType type, int value) {
        ...
        return StringNamedTemplate.format(
            CommonUtils.ifNullThan(map.get(language).increasedCharacteristic(), map.get(Language.DEFAULT).increasedCharacteristic()),
            params
        );
    }
    ...
    public static String currentCharacteristics(Language language, Characteristics characteristics) {
        ...
        return StringNamedTemplate.format(
            CommonUtils.ifNullThan(map.get(language).currentCharacteristics(), map.get(Language.DEFAULT).currentCharacteristics()),
            params
        );
    }
    ...
    public static String strengthButton(Language language) {
        return StringNamedTemplate.format(
            CommonUtils.ifNullThan(map.get(language).strengthButton(), map.get(Language.DEFAULT).strengthButton()),
    ...
    public static String agilityButton(Language language) {
        return StringNamedTemplate.format(
            CommonUtils.ifNullThan(map.get(language).agilityButton(), map.get(Language.DEFAULT).agilityButton()),
    ...
    public static String wisdomButton(Language language) {
        return StringNamedTemplate.format(
            CommonUtils.ifNullThan(map.get(language).wisdomButton(), map.get(Language.DEFAULT).wisdomButton()),
