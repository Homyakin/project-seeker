...
import ru.homyakin.seeker.game.group.error.NotEnoughMoneyForDonate;
...
public class DonateToGroupCommand {
    ...
    @Transactional
    public Either<NotEnoughMoneyForDonate, Personage> execute(
        GroupId groupId,
        ...
        if (personage.money().lessThan(money)) {
            return Either.left(NotEnoughMoneyForDonate.INSTANCE);
        }
